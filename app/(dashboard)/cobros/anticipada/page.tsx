    ...
    return (
      <div className="p-4 space-y-5">
        ...
        <div className="flex items-start justify-between gap-3 flex-wrap">
          ...
          <AgendaDatePicker fecha={fechaStr} fechaFin={hasFechaFin ? searchParams.fechaFin : undefined} baseHref="/cobros/anticipada" minDate={tomorrowStr} />
        </div>
  ...
  return (
    <div className="p-4 space-y-5">
      ...
      <div className="flex items-start justify-between gap-3 flex-wrap">
        ...
        <AgendaDatePicker fecha={fechaStr} baseHref="/cobros/anticipada" minDate={tomorrowStr} />
      </div>
