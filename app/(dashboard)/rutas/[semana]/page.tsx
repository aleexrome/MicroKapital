        ...
        {branches.map((branch) => {
          ...
          return (
            <div key={branch.id} className="space-y-3">
              ...
              {/* Layout:
                  - Sin ningún heredado en la sucursal → grid regular 2
                    cols (cards fluyen normalmente).
                  - Con al menos uno heredado → masonry manual: cortas
                    apiladas a la izq, heredadas apiladas a la der. Así
                    una card alta no deja hueco al lado de otras cortas.
                  Móvil siempre en una sola columna. */}
              {branchUsers.some((u) => u.heredada) ? (
