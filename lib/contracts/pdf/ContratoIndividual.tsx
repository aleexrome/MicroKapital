...
export interface ContratoIndividualProps {
...
/**
 * Contrato + pagaré para Crédito Individual con Aval (12 semanas).
 * Texto literal de CONTRATO_INDIVIDUAL.docx — incluyendo los typos
 * del original. NO reformulado.
 */
export function ContratoIndividual(props: ContratoIndividualProps) {
  const {
  ...
  return (
    ...
    >
      ...
      <Text style={styles.upper}>
        ...
        CANTIDAD QUE SE LE FUE OTORGADO A: {CLIENTE} A {fechaDesembolso} EN LA CIUDAD DE {CIUDAD},
        MÉXICO LA CANTIDAD {MONTO} ({montoLetras}).
      </Text>

      <Text style={styles.upper}>
        VALOR RECIBIDO A NUESTRA ENTERA SATISFACCIÓN. ESTE PAGARÉ FORMA PARTE A UNA SERIE
        ENUMERADA DE 1 AL 12 Y TODOS ESTÁN SUJETOS A LA CONDICIÓN DE QUE AL NO PAGARSE
        CUALQUIERA DE ELLOS EN FORMA SEMANAL SU VENCIMIENTO SERÁN EXIGIBLES TODOS LOS QUE SIGAN
      ...
      <Text style={styles.upper}>
        ...
        EL PRESENTE CONTRATO TENDRÁ COMO PLAZO 12 PAGOS SEMANALES, DENTRO DEL CUAL &quot;EL
